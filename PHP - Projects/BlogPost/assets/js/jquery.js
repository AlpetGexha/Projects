    ...
    (function ($, window, document, undefined) {
        ...
        AmsifySuggestags.prototype = {
            ...
            addTag: function (value, animate = true) {
                ...
                //Hashtag
                if (typeof value === "string" && this.settings.removeSpace) {
                    value = value.replace(/\s+/g, "");
                }

                //RemoveAllSpace
                if (typeof value === "string" && this.settings.hashtag) {
                    value = value.replace(/\s+/g, '#');
                }

                // RremoveSymbol
                if (typeof value === "string" && this.settings.removeSymbol) {
                ...
                value = "#" + value;
                var html = '<span class="' + this.classes.tagItem.substring(1) + '" data-val="' + value + '" value="' + value + '">' + this.getTag(value) + ' ' + this.setIcon() + ' </span>';
