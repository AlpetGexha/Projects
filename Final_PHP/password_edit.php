...
<div id="login-box" class="col-md-12">
  ...
  <div class="form-group">
    ...
    <label for="emri" class="text-info">Passowordi Momental</label><br>
      <input type="password" name="momental_password" class="form-control" autofocus="" required="" oninvalid="this.setCustomValidity('Ju lutem shkruani passowordin Momental');" oninput="this.setCustomValidity('');">
        </div>
   <div class="form-group">
     <label for="mbiemri" class="text-info">Passwordi i ri</label><br>
       <input type="password" name="new_password"  class="form-control" required="" oninvalid="this.setCustomValidity('Ju lutem shkruani passwordin e ri');" oninput="this.setCustomValidity('');"> 
         </div>
        <div class="form-group">
            <label for="email" class="text-info">Rishruaj passwordin e ri</label><br>
       <input type="password" name="continiu_password"  class="form-control" required="" oninvalid="this.setCustomValidity('Ju lutem shkruani rishruaj passwordin e ri');" oninput="this.setCustomValidity('');">
    </div>
